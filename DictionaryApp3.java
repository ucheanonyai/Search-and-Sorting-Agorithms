...
public class DictionaryApp3 {
	...
	System.out.println(dict.info()); /// return info
	...
	list=new Dictionary(200000); // create a new unsorted dictionary with the list of words (maxsize given)
        String addedfile=easy.readString();
	list.loadDictionary(addedfile); // load from file
